	...
	<?php } ?>
		<?php echo form_open_multipart('data_riwayat_pekerjaan/simpan','class="form-horizontal"'); ?>
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  	<div class="input-group date" data-provide="datepicker">
	                <input type="text" class="form-control datepicker" name="tanggal_awal_pekerjaan" id="tanggal_awal_pekerjaan" value="<?php echo $tanggal_awal_pekerjaan; ?>"  placeholder="Tanggal Mulai" style="width: 99%" disabled>
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				<div class="input-group date" data-provide="datepicker">
	                <input type="text" class="form-control datepicker" name="tanggal_akhir_pekerjaan" id="tanggal_akhir_pekerjaan" value="<?php echo $tanggal_akhir_pekerjaan; ?>"  placeholder="Tanggal Selesai" style="width: 99%" disabled>
	                <div class="input-group-addon">
	                    <span class="glyphicon glyphicon-th"></span>
	                </div>
	            </div>
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  <textarea class="form-control" name="alasan_berhenti" disabled><?php echo $alasan_berhenti; ?></textarea>
			</div>
		  </div> 
