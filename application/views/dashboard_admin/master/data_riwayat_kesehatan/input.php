		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  	<div class="input-group date" data-provide="datepicker">
	                <input type="text" class="form-control datepicker" name="tanggal_riwayat" id="tanggal_riwayat" value="<?php echo $tanggal_riwayat; ?>"  placeholder="Tanggal Mulai" style="width: 99%">
