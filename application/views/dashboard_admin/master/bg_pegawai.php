  ...
  <div class="navbar navbar-inverse">
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="control-group">
		  ...
		  <div class="control-group">
			<label class="control-label" for="no_KK">Nomor KK</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
			?>
			  <input type="text" class="span6" name="no_KK" id="no_KK" value="<?php echo set_value('no_KK'); ?>" placeholder="Nomor KK">
			<?php
			}
			else
			{
		  ...
		  <div class="control-group">
			<label class="control-label" for="kartu_askes_pegawai">Kartu BPJS Pegawai</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
			?>
			  <input type="text" class="span6" name="kartu_askes_pegawai" id="kartu_askes_pegawai" value="<?php echo set_value('kartu_askes_pegawai'); ?>" placeholder="Kartu BPJS Pegawai">
			<?php
			}
			else
			{
			?>
			  <input type="text" class="span6" name="kartu_askes_pegawai" id="kartu_askes_pegawai" value="<?php echo $kartu_askes_pegawai; ?>" placeholder="Kartu BPJS Pegawai">
			<?php
			}
			?>
			</div>
		  ...
		  <div class="control-group">
			<label class="control-label" for="tanggal_pengangkatan_cpns">Tanggal Pengangkatan CAPEG</label>
			<div class="controls">
			<?php
			if($st=="tambah")
			{
        ...
        <div class="tab-pane fade" id="dtjabatan">
          ...
          <div class="control-group">
			<label class="control-label" for="nip">Status Jabatans</label>
			<div class="controls">
