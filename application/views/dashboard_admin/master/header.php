            ...
            <ul class="nav">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="<?php echo base_url(); ?>laporan_pegawai_urut_kepangkatan"><i class="icon-retweet"></i> Laporan Pegawai - Unit Kerja </a></li>
	...
	<header class="jumbotron subhead" id="overview">
	  <div class="subnav">
		<ul class="nav nav-pills">
		  ...
		  <li><a href="<?php echo base_url(); ?>data_dp3/index/<?php echo $this->session->userdata("kode_pegawai"); ?>">Penilaian Atasa</a></li>
		</ul>
	  </div>
	</header>
