  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Master Pangkat </a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>master_eselon/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Data Pangkat</a></li>
			</ul>
		  </div>
