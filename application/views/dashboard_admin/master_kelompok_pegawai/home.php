...
<html lang="en">
            ...
            <ul class="nav">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="<?php echo base_url(); ?>master_kelompok_pegawai"><i class="icon-briefcase"></i> Kelompok Pegawai</a></li>                  
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Master Kelompok Pegawai</a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>master_kelompok_pegawai/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Kelompok Pegawai</a></li>
			</ul>
		  </div>
