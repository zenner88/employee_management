	...
	*/
	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			$d['data_pegawai'] = $this->db->query("
			select a.nip, a.nama_pegawai, b.golongan, a.id_kelompok_pegawai, d.nama_kelompok_pegawai, c.nama_status, a.id_pegawai, e.nama_jabatan, f.golongan, f.uraian, a.tanggal_sk_pangkat, g.uraian AS ura, g.golongan AS gol, SUBSTRING(tanggal_sk_pangkat,-4), LEFT(tanggal_sk_pangkat, CHAR_LENGTH(tanggal_sk_pangkat)-5)
			...
			left join tbl_master_kelompok_pegawai d on a.id_kelompok_pegawai=d.id_kelompok_pegawai
			left join tbl_master_jabatan e on a.id_jabatan=e.id_jabatan
			left join tbl_master_golongan f on a.id_golongan=f.id_golongan
			left join tbl_master_golongan g on f.next=g.id_golongan
