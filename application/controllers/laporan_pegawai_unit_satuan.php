	...
	*/
	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			if($this->session->userdata('id_satuan_kerja')=="Semua" && $this->session->userdata('lokasi_kerja')=="Semua")
			{
			...
			{
				$set_lap1['id_unit_kerja'] = $this->session->userdata('id_unit_kerja');
				$set_lap1['lokasi_kerja'] = $this->session->userdata('lokasi_kerja');				
			...
			else if($this->session->userdata('lokasi_kerja')=="Semua")
			{
				$set_lap1['id_unit_kerja'] = $this->session->userdata('id_unit_kerja');
			...
			else
			{
				...
				$set_lap2['lokasi_kerja'] = $this->session->userdata('lokasi_kerja');
