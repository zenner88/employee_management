	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			if ($this->session->userdata('id_status_jabatan_fungsional') == "" && $this->session->userdata('id_eselon_fungsional') == "" && $this->session->userdata('id_satuan_kerja_fungsional') == "" && $this->session->userdata('id_lokasi_kerja_fungsional') == "") {
				...
				if ($this->session->userdata('id_status_jabatan_fungsional') == "Semua" && $this->session->userdata('id_eselon_fungsional') == "Semua" && $this->session->userdata('id_satuan_kerja_fungsional') == "Semua" && $this->session->userdata('id_lokasi_kerja_fungsional') == "Semua") {
					$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja");
				} elseif ($this->session->userdata('id_eselon_fungsional') == "Semua" && $this->session->userdata('id_satuan_kerja_fungsional') == "Semua" && $this->session->userdata('id_lokasi_kerja_fungsional') == "Semua") {
				...
				} elseif ($this->session->userdata('id_satuan_kerja_fungsional') == "Semua" && $this->session->userdata('id_lokasi_kerja_fungsional') == "Semua") {
					$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_status_jabatan = '".$this->session->userdata('id_status_jabatan_fungsional')."' AND pegawai.id_golongan = '".$this->session->userdata('id_golongan')."'");
				} elseif ($this->session->userdata('id_lokasi_kerja_fungsional') == "Semua") {
	...
	public function export()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			if($this->session->userdata('id_status_jabatan_fungsional')=="Semua")
			{
				...
				$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_golongan = '".$this->session->userdata('id_eselon_fungsional')."' AND pegawai.id_satuan_kerja = '".$this->session->userdata('id_satuan_kerja_fungsional')."' AND pegawai.lokasi_kerja = '".$this->session->userdata('id_lokasi_kerja_fungsional')."'");
				
				
				
				
			} else if($this->session->userdata('id_status_jabatan_fungsional')=="Semua" && $this->session->userdata('id_eselon_fungsional')=="Semua") {
			...
			} else if($this->session->userdata('id_status_jabatan_fungsional')=="Semua" && $this->session->userdata('id_eselon_fungsional')=="Semua" && $this->session->userdata('id_satuan_kerja_fungsional')=="Semua") {
			...
			} else if($this->session->userdata('id_status_jabatan_fungsional')=="Semua" && $this->session->userdata('id_eselon_fungsional')=="Semua" && $this->session->userdata('id_satuan_kerja_fungsional')=="Semua" && $this->session->userdata('id_lokasi_kerja_fungsional')=="Semua") {
				$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja");
			} else if($this->session->userdata('id_status_jabatan_fungsional') != "Semua" && $this->session->userdata('id_eselon_fungsional') !="Semua" && $this->session->userdata('id_satuan_kerja_fungsional') !="Semua" && $this->session->userdata('id_lokasi_kerja_fungsional') !="Semua") {
				$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_status_jabatan = '".$this->session->userdata('id_status_jabatan_fungsional')."' AND pegawai.id_golongan = '".$this->session->userdata('id_golongan')."' AND pegawai.id_satuan_kerja = '".$this->session->userdata('id_satuan_kerja_fungsional')."' AND pegawai.lokasi_kerja = '".$this->session->userdata('id_lokasi_kerja_fungsional')."'");
			}
