	...
	*/
	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			if ($this->session->userdata('id_status_jabatan') == "" && $this->session->userdata('id_eselon') == "" && $this->session->userdata('id_satuan_kerja') == "" && $this->session->userdata('id_lokasi_kerja') == "") {
				...
				if ($this->session->userdata('id_status_jabatan') == "Semua" && $this->session->userdata('id_eselon') == "Semua" && $this->session->userdata('id_satuan_kerja') == "Semua" && $this->session->userdata('id_lokasi_kerja') == "Semua") {
					$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja");
				} elseif ($this->session->userdata('id_eselon') == "Semua" && $this->session->userdata('id_satuan_kerja') == "Semua" && $this->session->userdata('id_lokasi_kerja') == "Semua") {
					$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_status_jabatan = '".$this->session->userdata('id_status_jabatan')."'");
				} elseif ($this->session->userdata('id_satuan_kerja') == "Semua" && $this->session->userdata('id_lokasi_kerja') == "Semua") {
					$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_status_jabatan = '".$this->session->userdata('id_status_jabatan')."' AND pegawai.id_golongan = '".$this->session->userdata('id_golongan')."'");
	...
	public function export()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			if($this->session->userdata('id_status_jabatan')=="Semua")
			{
				...
				$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_golongan = '".$this->session->userdata('id_eselon')."' AND pegawai.id_satuan_kerja = '".$this->session->userdata('id_satuan_kerja')."' AND pegawai.lokasi_kerja = '".$this->session->userdata('id_lokasi_kerja')."'");
				
				
				
				
			} else if($this->session->userdata('id_status_jabatan')=="Semua" && $this->session->userdata('id_eselon')=="Semua") {
			...
			} else if($this->session->userdata('id_status_jabatan')=="Semua" && $this->session->userdata('id_eselon')=="Semua" && $this->session->userdata('id_satuan_kerja')=="Semua") {
			...
			} else if($this->session->userdata('id_status_jabatan')=="Semua" && $this->session->userdata('id_eselon')=="Semua" && $this->session->userdata('id_satuan_kerja')=="Semua" && $this->session->userdata('id_lokasi_kerja')=="Semua") {
				$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja");
			} else if($this->session->userdata('id_status_jabatan') != "Semua" && $this->session->userdata('id_eselon') !="Semua" && $this->session->userdata('id_satuan_kerja') !="Semua" && $this->session->userdata('id_lokasi_kerja') !="Semua") {
				$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_golongan ON pegawai.id_golongan = tbl_master_golongan.id_golongan LEFT JOIN tbl_master_status_jabatan ON pegawai.id_status_jabatan = tbl_master_status_jabatan.id_status_jabatan LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja WHERE pegawai.id_status_jabatan = '".$this->session->userdata('id_status_jabatan')."' AND pegawai.id_golongan = '".$this->session->userdata('id_golongan')."' AND pegawai.id_satuan_kerja = '".$this->session->userdata('id_satuan_kerja')."' AND pegawai.lokasi_kerja = '".$this->session->userdata('id_lokasi_kerja')."'");
			}
