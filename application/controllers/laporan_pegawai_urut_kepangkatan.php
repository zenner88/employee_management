	...
	public function index()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			if ($this->session->userdata('id_status_pegawai') == "" && $this->session->userdata('id_satuan_kerja') == "" && $this->session->userdata('id_lokasi_kerja') == "" && $this->session->userdata('id_gol_awal') == "" && $this->session->userdata('id_gol_akhir') == "" ) {
				...
				if ($this->session->userdata('id_status_pegawai') == "Semua" && $this->session->userdata('id_satuan_kerja') == "Semua" && $this->session->userdata('id_lokasi_kerja') == "Semua" && $this->session->userdata('id_gol_awal') == "Semua" && $this->session->userdata('id_gol_akhir') == "Semua") {
					$d['data_pegawai'] = $this->db->query('SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia, golongan.golongan FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_status_pegawai ON pegawai.status_pegawai = tbl_master_status_pegawai.id_status_pegawai LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja LEFT JOIN tbl_master_golongan as golongan ON pegawai.id_golongan = golongan.id_golongan');
				} elseif ($this->session->userdata('id_status_pegawai') == "Semua" && $this->session->userdata('id_satuan_kerja') == "Semua" && $this->session->userdata('id_lokasi_kerja') == "Semua" && $this->session->userdata('id_gol_awal') == "Semua" && $this->session->userdata('id_gol_akhir') == "Semua") {
					$d['data_pegawai'] = $this->db->query('SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia, golongan.golongan FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_status_pegawai ON pegawai.status_pegawai = tbl_master_status_pegawai.id_status_pegawai LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja LEFT JOIN tbl_master_golongan as golongan ON pegawai.id_golongan = golongan.id_golongan');
				} elseif ($this->session->userdata('id_satuan_kerja') == "Semua" && $this->session->userdata('id_lokasi_kerja') == "Semua" && $this->session->userdata('id_gol_awal') == "Semua" && $this->session->userdata('id_gol_akhir') == "Semua") {
				...
				} elseif ($this->session->userdata('id_lokasi_kerja') == "Semua" && $this->session->userdata('id_gol_awal') == "Semua" && $this->session->userdata('id_gol_akhir') == "Semua") {
					$d['data_pegawai'] = $this->db->query("SELECT pegawai.nip, pegawai.nama_pegawai, pegawai.tempat_lahir, pegawai.tanggal_lahir, pegawai.jenis_kelamin, pegawai.agama, pegawai.usia, golongan.golongan FROM tbl_data_pegawai as pegawai LEFT JOIN tbl_master_status_pegawai ON pegawai.status_pegawai = tbl_master_status_pegawai.id_status_pegawai LEFT JOIN tbl_master_satuan_kerja ON pegawai.id_satuan_kerja = tbl_master_satuan_kerja.id_satuan_kerja LEFT JOIN tbl_master_lokasi_kerja ON pegawai.lokasi_kerja = tbl_master_lokasi_kerja.id_lokasi_kerja LEFT JOIN tbl_master_golongan as golongan ON pegawai.id_golongan = golongan.id_golongan WHERE pegawai.status_pegawai = '".$this->session->userdata('id_status_pegawai')."' AND pegawai.id_satuan_kerja = '".$this->session->userdata('id_satuan_kerja')."'");
